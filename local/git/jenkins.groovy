 ...
 *
 * This example from: http://svn.wso2.org/repos/wso2/carbon/platform/branches/4.0.0/products/appfactory/1.0.0/vmware/appfactory_deployment/resources/jenkins.groovy
 *
 *
 */
...
def s = new HashSet()
def jenkinsUrl = gitblit.getString('groovy.jenkinsServer', 'http://jenkins:8080')
...
for(branch in s){
def triggerUrl = jenkinsUrl + "/git/notifyCommit?url=http://gitblit/$repository.name"+"&branches="+branch
logger.info(triggerUrl)
